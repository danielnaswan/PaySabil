                                      ...
                                      <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <a class="ps-3 me-4" href="#">
                                            <p class="m-0">PAY SABIL AL-HIKMAH</p>
                                          </a>
                                        </div>
                                        <button type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
                                          <i class="mdi mdi-plus-circle"></i> Carian / Info </button>
                                      </div>
                                    </div>
                                      ...
                                      <div class="col-xl-9 stretch-card grid-margin">
                                        <div class="card">
                                          <div class="card-body">
                                              ...
                                              <div>
                                                <div class="d-flex flex-wrap pt-2 justify-content-between sales-header-right">
                                                  <div class="d-flex me-5">
                                                    ...
                                                    <div class="ps-2">
                                                      <h4 class="mb-0 font-weight-semibold head-count">  </h4>
                                                      <span class="font-10 font-weight-semibold text-muted"></span>
                                                    </div>
                                                  </div>
                                            ...
                                            <p class="text-muted font-13 mt-2 mt-sm-0">Dashboard <a
                                                class="text-muted font-13" href="#"><u>  PAY SABIL</u></a>
                                            </p>
                                        ...
                                        <div class="card card-img">
                                          <div class="card-body d-flex align-items-center">
                                            <div class="text-white">
                                              <div class="text-white">
                                            	<img class="img-fluid w-100" src="<?php echo base_url();?>/assets/images/dashboard/heplogo.png"/>
                                              <!-- <img class="img-fluid w-100" src="<?php echo base_url();?>/assets/images/dashboard/hep.jpg" alt="" />-->
                                              <button class="btn bg-white font-12">Maklumat Lanjut..</button>
                                            </div>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="card">
                                          <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                              <div class="card-title"> Kelulusan <small class="d-block text-muted">August 01 - August 31</small>
                                              </div>
                                            ...
                                            <h3 class="font-weight-bold mb-0"> <span class="text-success h5"><i
                                      ...
                                      <div class="col-sm-6 stretch-card grid-margin">
                                        <div class="card">
                                          <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                              <div class="card-title"> Permohonan <small class="d-block text-muted">August 01 - August 31</small>
                                              </div>
                                              <div class="d-flex text-muted font-20">
                                                <i class="mdi mdi-printer mouse-pointer"></i>
                                                <i class="mdi mdi-help-circle-outline ms-2 mouse-pointer"></i>
                                        ...
                                        <div class="card">
                                          ...
                                          <div class="card-body px-3 text-dark">
                                            ...
                                            <div class="d-flex justify-content-between font-weight-semibold">
                                              <p class="mb-0">
                                                <i class="mdi mdi-star star-color pe-1"></i> </p>
                                              <p class="mb-0"></p>
                                            </div>
                                          </div>
                                        </div>
